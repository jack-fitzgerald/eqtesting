lddtest = function(runvar, cutpoint, epsilon, alpha = 0.05, power = 0.8, bin = NULL, bw = NULL, verbose = FALSE, plot = TRUE) {
  ...
  print(noquote("Fitzgerald, Jack (2024). Manipulation Tests in Regression Discontinuity: The Need for Equivalence Testing. https://jack-fitzgerald.github.io/files/RDD_equivalence.pdf."))
  #Store output
